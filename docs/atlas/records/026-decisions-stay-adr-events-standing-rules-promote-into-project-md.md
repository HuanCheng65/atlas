...
- This is the data-layer application of the same insight already recorded for skills in [[024-triggers-live-where-the-agent-always-sees-them-not-in-skill]]: what must influence behavior lives in an always-loaded surface; what is consulted on demand lives in bodies.
