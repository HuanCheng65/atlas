...
1. **Backlog duplicated open questions.** "Multi-machine sync" repeated
   [[Q-003]]; "Topic-sealing flow" repeated [[Q-002]]. Two sources of truth
...
- **Parallel-session friendly.** A shared ordered list (Up next, Backlog)
  ...
  directly at odds with [[D-006]]. Per-entity files (journal entries,
...
- One less surface for cross-machine merge conflicts ([[Q-003]]).
