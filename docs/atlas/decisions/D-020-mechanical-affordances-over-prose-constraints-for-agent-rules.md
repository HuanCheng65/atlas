...
supersedes: []
superseded-by: []
affects: [using-atlas, atlas-log, atlas-entity, atlas-orient, grill-me, atlas-bootstrap]
---
...
- Under the D-017 promotion test this rule is a constitution candidate of the archetypal kind: violating it produces no visible resistance, so it must live in the always-loaded surface.
