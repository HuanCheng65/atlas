...
related: [D-011, D-017, D-020]
source-journal: 2026-06-12-implement-design-review-decisions.md
supersedes: []
superseded-by: []
affects: [using-atlas, atlas-log, atlas-entity, grill-me, atlas-bootstrap]
---
...
- Binary rules resist agent drift better than calibrated ones (the D-020 logic): "say nothing" outlasts "say one line in the right register", which needed three repair rounds in three weeks.
...
- Constitution candidate under the D-017 test: violating it produces no visible resistance.
